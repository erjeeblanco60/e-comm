...
import { logout } from './usersAction'

//accept the keyword from dispatch home page and use it as parameters
...
export const productCreateAct = () => async (dispatch,getState) => {
  try {
